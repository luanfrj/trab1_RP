...
%\title{Rede de Sensores e Internet das Coisas - 2015/2}
...
% The paper headers
\markboth{UFES, Reconhecimento de Padrões, 2016/1}{Pós-Graduação em Informática}
...
%\boldmath
%\blindtext[1]
Trabalho realizado para a disciplina de Reconhecimento de Padrões no
Mestrado em Informática da UFES onde observou-se o comportamento do
método de descorrelação linear PCA para a detecção de falhas quando
aplicado ao resultado de simulação para um processo industrial
químico.
...
%\begin{IEEEkeywords}
%Sensoreamento, Modelagem Semântica, Sistema de Produção.
%\end{IEEEkeywords}
...
%	\item Temperatura e Tempo de exposição
%	\item Umidade Máxima
%	\item Umidade e Tempo de exposição
%	\item Luminosidade
%\end{enumerate}
%\vspace{3mm}
...
%  \caption{Tela inicial do Sistema de Monitoramento}
%	\label{fig:welcome}
%\end{figure}
