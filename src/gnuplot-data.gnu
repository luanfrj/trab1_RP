...
plot	"X.csv" every ::1  using 0:($1/20+0) title "c_{A0}",\
	"X.csv" every ::1  using 0:($2*4+1)  title "Q_{1}",\
	"X.csv" every ::1  using 0:($3/30+2)  title "T_{1}",\
	"X.csv" every ::1  using 0:($4/2+3)  title "L",\
	"X.csv" every ::1  using 0:($5/3+4)  title "c_{A}",\
	"X.csv" every ::1  using 0:($6/17+5)  title "c_{B}",\
	"X.csv" every ::1  using 0:($7/80+6)  title "T_{2}",\
	"X.csv" every ::1  using 0:($8*1+7)  title "Q_{5}",\
	"X.csv" every ::1  using 0:($9*4+8)  title "Q_{4}",\
	"X.csv" every ::1  using 0:($10/20+9)  title "T_{3}",\
	"X.csv" every ::1  using 0:($11/60000 + 10)  title "PCW",\
	"X.csv" every ::1  using 0:($12/25+11)  title "CNT_{1}",\
	"X.csv" every ::1  using 0:($13/40+12)  title "CNT_{3}=SP_Q5",\
	"X.csv" every ::1  using 0:($14*1+13)  title "CNT_{2}",\
	"X.csv" every ::1  using 0:($15*1+15)  title "INV CON",\
	"X.csv" every ::1  using 0:($16*1+16)  title "CW DP CON",\
	"X.csv" every ::1  using 0:($17*1+17)  title "EFFL DP CON",\
	"X.csv" every ::1  using 0:($18*1+18)  title "MOLBAL CON"
